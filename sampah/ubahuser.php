      ...
      <div class="box-1">
        ...
        <div class="card">
          ...
          <form action="" method="post" class="mt-3" enctype="multipart/form-data">
            ...
            <div class="input-group">
                <input type="number" name="nim" id="nim" required="required" class="form-control mt-2" placeholder="Masukkan Nomor Induk Kewarganegaraan" value="<?php echo $biodata["nim"]; ?>">
            </div>
            </div>
